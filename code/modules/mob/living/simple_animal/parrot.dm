					...
					if(ears)
						...
						for(var/possible_phrase in speak)
							if(copytext_char(possible_phrase,1,3) in department_radio_keys)
								possible_phrase = copytext_char(possible_phrase,3,length_char(possible_phrase))
					else
			...
			if(speak.len)
				...
				if(available_channels.len && src.ears)
					for(var/possible_phrase in speak)
						...
						if(copytext_char(possible_phrase,1,3) in department_radio_keys)
							possible_phrase = "[useradio?pick(available_channels):""] [copytext_char(possible_phrase,3,length_char(possible_phrase)+1)]" //crop out the channel prefix
						else
					...
					for(var/possible_phrase in speak)
						if(copytext_char(possible_phrase,1,3) in department_radio_keys)
							possible_phrase = "[copytext_char(possible_phrase,3,length_char(possible_phrase)+1)]" //crop out the channel prefix
						newspeak.Add(possible_phrase)
				speak = newspeak
