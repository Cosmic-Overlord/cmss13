...
/obj/structure/machinery/brig_cell/proc/do_pardon(mob/user)
	...
	message_admins("[key_name(user, 1)](<A HREF='?_src_=admin_holder;[HrefToken(forceGlobal = TRUE)];adminplayerobservejump=\ref[user]'>JMP</A>) has pardoned [viewed_report.incident.criminal_name].")
...
/obj/structure/machinery/brig_cell/proc/timer_pause(mob/living/user)
	...
	message_admins("[key_name(user, 1)](<A HREF='?_src_=admin_holder;[HrefToken(forceGlobal = TRUE)];adminplayerobservejump=\ref[user]'>JMP</A>) has paused the jail timer of [incident.criminal_name].")
...
/obj/structure/machinery/brig_cell/proc/timer_end(mob/living/user = null)
	...
	if (user)
		message_admins("[key_name(user, 1)](<A HREF='?_src_=admin_holder;[HrefToken(forceGlobal = TRUE)];adminplayerobservejump=\ref[user]'>JMP</A>) has prematurely ended the jail timer of [incident.criminal_name].")
...
/obj/structure/machinery/brig_cell/proc/timer_reset(mob/living/user)
	...
	message_admins("[key_name(user, 1)](<A HREF='?_src_=admin_holder;[HrefToken(forceGlobal = TRUE)];adminplayerobservejump=\ref[user]'>JMP</A>) has reset the jail timer of [incident.criminal_name].")
